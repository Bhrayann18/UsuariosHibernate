...
public class RolController {
    public static void main(String[] args) {
		...
		SessionFactory factory = new Configuration().configure("hibernate.cfg.xml").addAnnotatedClass(Rol.class)
				.buildSessionFactory();
		...
		try {
			...
			System.out.println("Rol almacenado");
		} finally {
